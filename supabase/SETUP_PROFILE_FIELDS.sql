...
-- existing directory_facets function (SETUP_DIRECTORY_SEARCH.sql).
-- Safe to re-run. All new columns/tables are optional, so existing accounts
-- keep working with them blank.
-- ============================================================================
